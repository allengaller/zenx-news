...
var miniBlogShare = function() {    
    $('<img id="imgSinaShare" class="img_share" title="将选中内容分享到新浪微博" src="/wp-content/themes/Anenv/images/t_sina.gif" /><img id="imgQqShare" class="img_share" title="将选中内容分享到腾讯微博" src="/wp-content/themes/Anenv/images/t_qq.gif" />').appendTo('body');    
    $('.img_share').css({    
        display : 'none',    
        position : 'absolute',    
        cursor : 'pointer'    
