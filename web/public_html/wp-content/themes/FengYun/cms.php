	...
	<div class="slider_box">
		...
		<div class="hot_box">
			...
			<?php include (TEMPLATEPATH . '/includes/rolling_n.php'); ?>
                ...
                <div class="ads1_top"></div>

                <center><div class="ads1"><a href="http://www.zuifengyun.com/blogger" target="_blank" title="博友大全-博友互访平台" alt="博友大全-博友互访平台"><img src="<?php bloginfo('template_directory') ?>/images/top1.jpg" style="width:250px;height:80px;"></a></div>                         

                <div class="ads1"><a href="http://www.zuifengyun.com/rss-2" target="_blank" title="订阅-醉风云博客" alt="订阅-醉风云博客"><img src="<?php bloginfo('template_directory') ?>/images/top2.jpg" style="width:250px;height:80px;"></a></div>

                <a href="http://www.zuifengyun.com/gallery/tupianshijie" target="_blank" title="美图欣赏-帅哥美女" alt="美图欣赏-帅哥美女"><img src="<?php bloginfo('template_directory') ?>/images/top3.jpg" style="width:250px;height:80px;"></a></center>
