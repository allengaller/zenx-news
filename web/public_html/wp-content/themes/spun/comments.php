...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav role="navigation" id="comment-nav-above" class="site-navigation comment-navigation">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'spun' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&laquo;', 'spun' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( '&raquo;', 'spun' ) ); ?></div>
