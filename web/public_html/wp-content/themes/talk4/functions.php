...
<li>站长QQ：<font class="red">286589914</font></li>
<?php }
...
<div class="rm_wrap">
	<h2><?php echo $themename; ?> 主题设置</h2>
		<p>当前使用主题: <?php echo $themename; ?> | 设计者:<a href="http://blog.ui90.com" target="_blank"> 胖子马</a> | <a href="http://blog.ui90.com/?p=8812" target="_blank">查看主题更新</a></p>
	<div class="rm_opts">
