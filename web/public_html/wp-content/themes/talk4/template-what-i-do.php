	...
	<div class="fluidCon">
		...
		<div class="post_detail" id="post-<?php the_ID(); ?>">
			...
			<div class="post_content"><!-- 此处广告代码需要优化 -->
				...
				<div class="content">
					<p>胖子马有免费和部分收费原创主题作品，免费主题都可以在本站下载到或者在QQ群共享中获得（群号：152590370），收费主题购买流程如下：</p>
				...
				<div class="content">
					<p>			胖子马提供的WordPress主题服务大致为：全新设计或根据您提供的设计稿（pad、jpg），或者您所要模仿的样式，或者由我帮您设计，然后制作成 wordpress主题包或在您已有的wordpress主题上做一定的修改。通常会花费1~7个工作日。费用可参考下表：</p>
						...
						<tbody>
							...
							<tr>
								...
								<td class="c">
									...
									<p>3、胖子马不承担仿制网站导致的任何版权问题和其他纠纷；</p>
								</td>
								<td class="c">
									<p class="price">博客网站:1080</p>
									<p class="price">企业网站:1580</p>
					...
					<dl class="other mt10">
					<dt>网站主题定制流程：</dt>
						<dd>胖子马为客户提供各种类型的 WordPress 网站定制设计服务，为方便客户了解网站的定制流程，请务必详细阅读以下具体定制流程：</dd>
					...
					<dl class="other mt10">
						<dt>主题定制协议：</dt>
						<dd>1、对于胖子马提供的所有主题设计服务，具体设计报价视主题需求的具体情况而定（设计复杂度、实现功能难易度等）；</dd>
						<dd>2、定制设计主题，胖子马保留主题的设计版权，主题只且只能用于双方协议的网站/博客使用。主题不得用作他用、不得以任何形式转卖他人使用；如有疑问，请及时与胖子马联系协商，否则胖子马不再负责其网站的后期服务；</dd>
						<dd>3、对于客户提交的仿制主题，胖子马不承担任何因此而带来的版权问题和其他纠纷，请慎重选择主题仿制对象；</dd>
						<dd>4、胖子马帮助用户进行主题必需插件的安装、整合、调试，但不保证所有插件的兼容性（毕竟 WordPress 插件鱼龙混杂，插件与插件，插件与程序间都可能会出现不兼容性）；</dd>
						<dd>5、所有主题设计服务，在双方达成一致意见后，定制需求方须预付整个主题设计费用的50%，剩余设计费用在主题提交完成后，准时支付；</dd>
						<dd>6、胖子马不提供其他因主机空间、PHP版本、MYSQL版本等非主题设计因素而导致的主题使用问题，具体解决方法须联系对应服务商解决；</dd>
						<dd>7、对于胖子马发布的原创免费主题，请非商业主题用户尊重主题作者的劳动成果，务必保留主题底部的胖子马的版权链接，胖子马拥有永久设计版权。用户不得随意隐藏或删除主题底部的胖子马版权文字链接，如需隐藏或删除该链接，需额外支付80元的版权费用；</dd>
