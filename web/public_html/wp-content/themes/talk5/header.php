...
<header id="topLevel" class="clx">
    ...
    <ul class="network clx">			
		...
		<li><a rel="nofollow" href="http://jisuhudong.com">资讯</a></li>
        <li><a target="_blank" rel="nofollow" href="http://diandongxi.com">互联网</a></li>
        <li><a target="_blank" rel="nofollow" href="http://36kr.com">移动互联网</a></li>
        <li><a target="_blank" href="<?php bloginfo('siteurl');?>/about_me">关于</a></li>
    </ul><!--network end-->
